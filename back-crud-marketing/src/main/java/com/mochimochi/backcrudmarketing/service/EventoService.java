...
public class EventoService {
    ...
    public EventoDTO findById(@NotNull @Positive String id){
    ...
    public EventoDTO update( @NotNull @Positive String id, @Valid @NotNull EventoDTO evento){
    ...
    public void delete(@NotNull @Positive String id){
